import './SellerOrdersShippedList.css'
import { useState, useEffect } from 'react'
import api from './Api'

const SellerOrdersShippedList = ({ order }) => {
    ...
    function PrintShipped() {
        return (
            <div className='seller-order-whole-box3'>
                <div className='seller-order-page-box3'>
                    <div className='seller-order-page-description'>
                        <div className='seller-order-page-first-row'>
                            <span>{order.order.time} | Shipped</span>
                        </div>
...
export default SellerOrdersShippedList