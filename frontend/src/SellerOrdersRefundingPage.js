...
import SellerOrdersRefundingList from './Components/SellerOrdersRefundingList'

const SellerOrdersRefundingPage = () => {
        ...
        <div>
            ...
            <Box sx={{ flexGrow: 1, display: 'flex' }}>
                ...
                >
                    ...
                    <Tab label="待退款" diasbled {...a11yProps(1)} />
                ...
                <TabPanel value={value} index={1}>
                    {orders.length > 0 ? orders.map((order, index) => (
                        ...
                        <SellerOrdersRefundingList order={order} />
...
export default SellerOrdersRefundingPage