...
import SellerOrdersRefundedList from './Components/SellerOrdersRefundedList'

const SellerOrdersRefundedPage = () => {
        ...
        <div>
            ...
            <Box sx={{ flexGrow: 1, display: 'flex' }}>
                ...
                >
                    ...
                    <Tab label="已退款" disabled {...a11yProps(2)} />
                ...
                <TabPanel value={value} index={2}>
                    {orders.length > 0 ? orders.map((order, index) => (
                        ...
                        <SellerOrdersRefundedList order={order} />
...
export default SellerOrdersRefundedPage