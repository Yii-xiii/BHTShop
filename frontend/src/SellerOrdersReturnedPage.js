...
import SellerOrdersReturnedList from './Components/SellerOrdersReturnedList'
...
const SellerOrdersReturnedPage = () => {
    ...
    const fetchOrders = async () => {
        const data = await api.getSellerOrderListByStatusAndPage('returned', 1)
        return data.data
    }
